...
class Nblm < Formula
    ...
    on_macos do
      on_arm do
        url "https://github.com/K-dash/nblm-rs/releases/download/v0.1.5/nblm-macos-aarch64.tar.gz"
        sha256 "4c68904c08f18a39e86c4a04231e23c85f35f3a94314e7fb8e00ead57d553888"
      end
      on_intel do
        url "https://github.com/K-dash/nblm-rs/releases/download/v0.1.5/nblm-macos-x86_64.tar.gz"
